    ...
    public static class WindowPlacement
    {
        ...
        private static void SetPlacement(IntPtr windowHandle, string placementXml)
        {
            ...
            try
            {
                ...
                _ = SetWindowPlacement(windowHandle, ref placement);
            }
        ...
        {
            _ = GetWindowPlacement(windowHandle, out WINDOWPLACEMENT placement);
        ...
        public static void ApplyPlacement(this Window window)
        {
            ...
            {
                Debug.WriteLine($"Couldn't read position for {className}:  {exception}");
            }
        ...
        public static void SavePlacement(this Window window)
        {
            ...
            {
                Debug.WriteLine($"Couldn't write position for {className}:  {exception}");
            }
        }
        private static string Directory => Path.Join(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "CYKViewer");
    }
}